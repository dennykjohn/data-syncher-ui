...
const Billing = () => {
  ...
  if (isLoadingUsage || isLoadingMonthlyUsage || isLoadingAnnualBilling)
            ...
            <>
              {(usageData?.available_connections ?? []).length === 0 ? (
                ...
                <Table
                  ...
                  pageSize={10}
                  totalElements={
                    (usageData?.available_connections ?? []).length
                  }
                  updateCurrentPage={() => {}}
                  hidePagination
                />

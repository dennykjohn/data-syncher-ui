...
const BatchGroupedPanel = ({ connectionId }: BatchGroupedPanelProps) => {
  ...
  const unassigned = useMemo<UnassignedTable[]>(
    ...
    <>
      ...
      >
        ...
        >
          ...
          {!isLoading && batches.length === 0 && unassigned.length === 0 && (
            <Flex
              direction="column"
              alignItems="center"
              gap={2}
              ...
              >
                ...
                {unassigned.length > 1 && (
                  <Button
                    ...
                    variant="ghost"
                    onClick={() =>
                      setPickerTables(unassigned.map((u) => u.table_name))
                    }
                  >
                    Move all
                  </Button>
